...
const Settings = (props) => {
    ...
    const { name, profilePic } = props.route.params
        ...
        <ImageBackground style={styles.container} source={appImages.backGround}>
            <View style={{ backgroundColor: 'rgba(0,0,0,0.9)', height: '100%', width: '100%' }}>
                ...
                <ScrollView>
                    ...
                    <AccountSettingbtn Title={'Edit Profile'} name={'user-alt'} type={'font-awesome-5'} onPress={() => { props.navigation.navigate('EditProfile') }} />
                    ...
                    <AccountSettingbtn Title={'Favorites'} name={'heart'} type={'entypo'} onPress={() => { props.navigation.navigate('Fav') }} />
                        ...
                        <View style={styles.centeredView}>
                            <View style={styles.modalView}>
                                ...
                                <View style={styles.buttonView}>
                                    ...
                                    <ModalButton backgroundColor={colors.button} btnColor={colors.whiteText} Title={'Logout'} onPress={logoutFun} />
                                </View>
                            </View>
                        </View>
                    </Modal>
